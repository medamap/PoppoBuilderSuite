...
class SetupWizard {
  ...
  async runSetup(options = {}) {
    ...
    for (const step of this.steps) {
      ...
      // If Claude is available and auto-fix didn't work, use Claude guide
      if (this.claudeAvailable) {
        console.log(chalk.yellow(`\nStarting interactive guide with Claude CLI...`));
    ...
    console.log(chalk.gray('PoppoBuilder is now ready to use. You can run "poppobuilder init" to continue.\n'));
    return true;
  }
  ...
  async checkClaudeAvailability() {
    try {
      ...
      console.log(chalk.green('✓ Claude CLI detected'));
    } catch {
