...
// Silence LogRotator messages for clean output
LogRotator.setGlobalSilent(true);

class StatusCommand {
  constructor() {
    console.warn(chalk.yellow('⚠️  DEPRECATED: This status command implementation is deprecated.'));
    console.warn(chalk.yellow('   Please use the unified status command at lib/commands/status-unified.js'));
    console.warn(chalk.yellow('   This implementation will be removed in a future version.\n'));
