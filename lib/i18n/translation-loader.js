...
class TranslationLoader {
  constructor() {
    // Try multiple possible locations for locales directory
    const possiblePaths = [
      path.join(__dirname, '../../locales'),  // Development path
      path.join(__dirname, '../../../locales'),  // Alternative path
      path.join(process.cwd(), 'locales'),  // Current directory
      path.resolve(__dirname, '../../locales')  // Absolute path
    ];
